  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Information System - Empowering Employers with Comprehensive Employee Data Management, Vacation Planning, and Payroll Processing at Your Fingertips"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Information System - Empowering Employers with Comprehensive Employee Data Management, Vacation Planning, and Payroll Processing at Your Fingertips`}
            </Text>
            <Box
